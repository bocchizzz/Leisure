...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'task-edit',
    component: () => import('@/views/task/TaskPublish.vue'),
    meta: { layout: 'main', title: '编辑任务', requiresAuth: true, nav: 'publish' },
  },
  {
    path: '/tasks/:id(\\d+)',
    name: 'task-detail',
    component: () => import('@/views/task/TaskDetail.vue'),
    meta: { layout: 'main', title: '任务详情', nav: 'hall' },
  },
  {
    path: '/tasks/:id(\\d+)/applications',
    name: 'application-manage',
    component: () => import('@/views/application/ApplicationManage.vue'),
    meta: { layout: 'main', title: '申请管理', requiresAuth: true, nav: 'my-tasks' },
  },
  {
    path: '/my-tasks',
    name: 'my-tasks',
  ...
  },
  {
    ...
    meta: { layout: 'main', title: '契约履约', requiresAuth: true, nav: 'my-tasks' },
  },
  ...
  },
  {
    ...
    meta: { layout: 'main', title: '案件详情', requiresAuth: true, nav: 'court' },
  },
  {
    path: '/precedents',
    name: 'precedents',
    component: () => import('@/views/court/Precedents.vue'),
    meta: { layout: 'main', title: '判例库', nav: 'court' },
  },
  ...
  // —— 猎人/档案 ——
  {
    ...
    meta: { layout: 'main', title: '赏金布档案', nav: 'profile' },
  },
  {
    path: '/leaderboard',
    name: 'leaderboard',
  ...
  },
  {
    ...
    meta: { layout: 'main', title: '校园认证', requiresAuth: true, nav: 'profile' },
  },
